...
const Birds =()=>{
    const [image,setImage] = useState([])
        axios.get(`https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=c5a4ea19746b781fd5d6577f9cf573f5&tags=birds&per_page=10&page=1&format=json&nojsoncallback=1`)
        .then(data => {
